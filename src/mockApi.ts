const bob: { id: number; firstName: string; lastName: string; thumbnail: string } = {
    id: 23,
    firstName: 'Bob',
    lastName: 'Greatlance',
...
const jack: { id: number; firstName: string; lastName: string; thumbnail: string } = {
    id: 48,
    firstName: 'Jack',
    lastName: 'Dowager',
...
interface Message {
    id: number;
    from: { id: number; firstName: string; lastName: string; thumbnail: string };
    message: string;
    date: string;
}
...
export const currentUser: string = JSON.stringify(bob);
export const conversation: string = JSON.stringify(messages);
